...
pub(super) fn command_help(name: &str) -> Option<CommandHelp> {
    match name {
        ...
        "fgrep" => Some(CommandHelp {
            name: "fgrep",
            usage: "fgrep [-n] [-b] [-i] [-x] [-w] [-v] [-z] [-A NUM] [-B NUM] [-C NUM] [-NUM] [-c|-q|-l|-L] [-H|-h] [-Z] [-s] [-T] [-D ACTION] [-d ACTION] [--label LABEL] [--line-buffered] [-a|-I|-U|--binary-files=TYPE] [-m NUM] [--color[=WHEN]|--colour[=WHEN]] [-e PATTERN | -f FILE]... [-V|--version] [--no-ignore-case] [--auto|--no-direct|--direct] [--report-gbps] [pattern] <file> [file ...]",
            ...
            notes: &[
                ...
                "On this Linux host, -D/--devices=read keeps reading device-like positional inputs (including FIFOs), -D/--devices=skip omits them from the search, -d/--directories=read matches GNU grep's local EISDIR surface, and -d/--directories=skip omits directory operands without adding recursive traversal.",
                ...
                "Regex/search-mode families (-E/-G/-P), recursive include/exclude traversal (-r/-R/--include/--exclude* and --directories=recurse) stay outside this slice.",
