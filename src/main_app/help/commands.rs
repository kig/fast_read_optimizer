...
pub(super) fn command_help(name: &str) -> Option<CommandHelp> {
    match name {
        ...
        "du" => Some(CommandHelp {
            name: "du",
            usage: "du [-0] [-s] [-a] [-S] [-b|--bytes] [-k] [-m] [-h|--human-readable|--si] [--apparent-size] [-H|--dereference-args] [-P|--no-dereference] [-B SIZE|--block-size=SIZE] [-d depth|--max-depth=depth] [-t SIZE|--threshold=SIZE] [--] [path ...]",
            ...
            notes: &[
                ...
                "-H/--dereference-args follows only command-line symlink operands; traversal still treats discovered symlinks as leaf entries.",
                "-P/--no-dereference keeps the GNU default: do not follow symlinks unless -H was requested later.",
        ...
        "sort" => Some(CommandHelp {
            name: "sort",
            usage: "sort [-c|--check] [-g|--general-numeric-sort] [-h|--human-numeric-sort] [-m|--merge] [-M|--month-sort] [-n|--numeric-sort] [-k KEY|--key=KEY] [-r|--reverse] [-u|--unique] [-V|--version-sort] [-z|--zero-terminated] [-o FILE|--output=FILE] [-T DIR|--temporary-directory=DIR] [--auto|--no-direct|--direct] [--report-gbps] [--] [file ...]",
            ...
            notes: &[
                "This bounded slice implements the default bytewise newline-delimited case plus bounded -k/--key field selection, -g/-h/-M/-n/-V compatibility modes, -z NUL-terminated records, merge/check, reverse/unique output, -o output-file writes, and -T spill-directory selection.",
        ...
        "tail" => Some(CommandHelp {
            name: "tail",
            usage: "tail [-n lines|-c bytes] [--lines lines|--bytes bytes] [--lines=lines|--bytes=bytes] [-z|--zero-terminated] [-q|--quiet|--silent|-v|--verbose] [--auto|--no-direct|--direct] [--report-gbps] <file> [file ...]",
